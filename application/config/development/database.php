...
$db['default']['password'] = 'dessys';
$db['default']['database'] = 'conquest';
...
$db['master']['password'] = 'dessys';
$db['master']['database'] = 'conquest';
...
$db['slave']['password'] = 'dessys';
$db['slave']['database'] = 'conquest';
